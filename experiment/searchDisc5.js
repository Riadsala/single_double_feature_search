...
function WelcomePracticeRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of WelcomePracticeComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function targetStimuliRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of targetStimuliComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function first_fixRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of first_fixComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function targetInfoRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of targetInfoComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
