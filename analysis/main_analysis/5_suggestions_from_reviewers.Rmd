...
my_prior <- c(
  ...
  prior_string("normal(-1, 0.3)", class = "b", coef = "block1"),
  prior_string("normal(-1, 0.3)", class = "b", coef = "block2"),
  prior_string("normal(-1, 0.3)", class = "b", coef = "block3"),
  prior_string("normal(-1, 0.3)", class = "b", coef = "block4"),
